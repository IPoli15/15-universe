...
QUERY_RERSERVA_POR_ID = """SELECT R.id_reserva, R.cant_tickets, U.nombre, E.nombre_evento, E.precio_entrada FROM reservas R
...
def reserva_by_id(id_reserva):
    return run_query(QUERY_RERSERVA_POR_ID, {'id_reserva': id_reserva}).fetchall()
